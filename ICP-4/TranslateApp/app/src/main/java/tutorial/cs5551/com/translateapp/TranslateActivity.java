...
public class TranslateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner1 = (Spinner) findViewById(R.id.spinner_fr);
        spinner2 = (Spinner) findViewById(R.id.spinner_to);
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this, R.array.Language_Names,android.R.layout.simple_spinner_item);
    ...
    public void translateText(View v) {
        ...
        fromLang = getResources().getStringArray(R.array.Language_Codes)[spinner1.getSelectedItemPosition()];
        ToLang = getResources().getStringArray(R.array.Language_Codes)[spinner2.getSelectedItemPosition()];
